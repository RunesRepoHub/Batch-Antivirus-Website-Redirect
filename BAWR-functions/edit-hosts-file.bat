...
set playdr2.tw=127.0.0.1
set a.gwas.perl.sh=127.0.0.1
set playdr2.tw=127.0.0.1
set playdr2.tw=127.0.0.1
set slyip.net=127.0.0.1
set walmartforchristmas.website=127.0.0.1
set maypole.co.kr=127.0.0.1
set 211.255.23.149=127.0.0.1
set 1e90ff.com=127.0.0.1
set 4169e1.com=127.0.0.1
set 184.164.143.90=127.0.0.1
set 184.164.143.90=127.0.0.1
set 88.214.241.85 =127.0.0.1
set 88.214.241.85=127.0.0.1
set expendablesearch.com=127.0.0.1
set 88.214.241.85=127.0.0.1
set 216.172.63.56=127.0.0.1
set lightforcefinder.com=127.0.0.1
set et-phone.co.kr=127.0.0.1
set bnicsl.no-ip.org=127.0.0.1
set fantasy.legend.rocks=127.0.0.1
set irc.byroe.net=127.0.0.1
set mafia.bot.nu=127.0.0.1
set 199.114.220.147=127.0.0.1
